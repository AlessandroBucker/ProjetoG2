      ...
      <aside className="fixed top-0 left-0 h-screen group w-20 hover:w-64 bg-slate-900 text-white flex flex-col transition-all duration-300 z-50 shadow-xl">
        ...
        <nav className="flex-1 p-4 space-y-2 overflow-hidden">
          <button
            ...
            className="flex items-center w-full p-3 rounded-lg hover:bg-slate-800 transition-all whitespace-nowrap"
          >
        ...
        <button
          onClick={() => navigate("/")}
          className="p-6 flex items-center border-t border-slate-800 hover:bg-red-500/10 text-red-400 transition-all"
        >
