import { 
  ...
  ArrowRight, FileText, TrendingUp, Clock 
} from "lucide-react";
    ...
    <div className="max-w-7xl mx-auto px-4 pb-12">
      ...
      <div className="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">Bem-vindo ao painel de controle do ProjetoG2.</p>
        </div>
        <button 
          onClick={() => navigate('/nova-analise')}
          className="flex items-center space-x-2 bg-slate-900 text-white px-6 py-2.5 rounded-xl font-bold hover:bg-slate-800 transition-all active:scale-95 shadow-sm"
        >
          <TrendingUp size={18} />
          <span>Nova Análise Rápida</span>
        </button>
      </div>
